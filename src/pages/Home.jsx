    ...
    <div className="bg-light">
      ...
      <section className="container py-5 text-center">
        ...
        <div className="col-md-6 mt-4 mt-md-0">
          ...
          <div className="col-md-6 text-md-start text-center">
            ...
            <p className="lead">أفضل مكان لشراء الإلكترونيات والمنتجات الأصلية بأسعار منافسة</p>
            <Link to="/shop" className="btn btn-primary mt-3">تسوق الآن</Link>
          </div>
        ...
        <div className="row g-4">
          <div className="col-md-4">
            <div className="card shadow-sm h-100">
              <img src="/images/phones/apple-iphone-15-pro-max-1.jpg" className="card-img-top" alt="product" style={{height: "350px"}}/>
              <div className="card-body">
                <h6 className="card-title my-3">iPhone 15 Pro Max</h6>
                <p className="card-text text-muted">1400 دولار</p>
                <Link to="/shop" className="btn btn-sm btn-outline-primary">تسوق الأن</Link>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-4">
            <div className="card shadow-sm h-100">
              <img src="/images/Laptop/MacBook Pro 14-inch.jpg" className="card-img-top" alt="product" style={{height: "350px"}}/>
              <div className="card-body">
          ...
          <div className="col-md-4">
            <div className="card shadow-sm h-100">
              <img src="/images/headphones/Apple AirPods Pro.jpg" className="card-img-top" alt="product" style={{height: "350px"}}/>
              <div className="card-body">
      ...
      <section className="bg-warning text-dark text-center py-5">
        <div className="container">
          ...
          <Link to="/shop" className="btn btn-dark mt-2">استفد الآن</Link>
        </div>
      </section>
      ...
      <section className="container py-5">
        ...
        <div className="row text-center g-4">
          ...
          <div className="col-md-3">
            <div className="p-3 bg-white shadow-sm rounded">✅ منتجات أصلية</div>
          </div>
          <div className="col-md-3">
            <div className="p-3 bg-white shadow-sm rounded">📞 دعم فني متواصل</div>
          </div>
        </div>
      </section>
